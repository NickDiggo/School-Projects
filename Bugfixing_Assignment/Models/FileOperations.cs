                ...
                while (!reader.EndOfStream)
                {
                    ...
                    switch (onderdeelType)
                    {
                        case "geheugen":
                            ...
                            int moduleGrootte;
                            double prijsGeheugen;
                            string type = onderdeelGegevens[1];
                            //parse naar tryparse
                            int.TryParse(onderdeelGegevens[2], out moduleGrootte);
                            double.TryParse(onderdeelGegevens[3], out prijsGeheugen);
                        ...
                        case "grafischeKaart":
                            ...
                            onderdeel = new GrafischeKaart(
                                chipsetGrafischeKaart,
                                werkgeheugen,
                                prijsGrafischeKaart
                            );
                            break;
