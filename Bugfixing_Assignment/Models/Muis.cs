...
namespace ComputerWinkel.Models
{
    public class Muis : Accessoire
    {
        ...
        public Muis(
            ...
            string model,
            bool isDraadloos,
            bool heeftRgbVerlichting,
            double prijs,
            int aantalInstellingen,
            int max_Dpi
        )
        ...
        {
            //prijs weg staat in accesoires
            return $"Muis: {base.ToString()} - Aantal instellingen {AantalInstellingen} - Max DPI {MaxDpi}";
        }
    }
}
