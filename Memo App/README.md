...
https://v0.app/chat/memo-application-eUjwBHQvC0O?ref=M8DL7A

# Inlog gegevens

user : nicktest1@test.be
password : Test123!

# TODO (so i don't forget)

!!!reminder: session verwijderen in prisma studio => ook cookie in sc verwijderen anders mismatch!!!
