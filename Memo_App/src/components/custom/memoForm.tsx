...
import {MessageSquare, ImageIcon, ChevronLeft, ChevronRight, Plus, Edit, Trash2} from 'lucide-react'
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex gap-3 pt-6 border-t border-border">
        <Link href={`/memos/${id}/bewerken`} className="flex-1">
        ...
        <ActionButton
          className="flex-1"
          variant="destructive"
          action={() => deleteMemoServerFunction({id})}
